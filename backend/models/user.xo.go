// Package models contains the types for schema 'react_go_development'.
package models
...
func (u *User) Insert(db XODB) error {
	...
	const sqlstr = `INSERT INTO react_go_development.users (` +
		`name` +
		`) VALUES (` +
		`?` +
		`)`
...
func (u *User) Delete(db XODB) error {
	...
	// sql query
	const sqlstr = `DELETE FROM react_go_development.users WHERE id = ?`
...
// UserByID retrieves a row from 'react_go_development.users' as a User.
//
